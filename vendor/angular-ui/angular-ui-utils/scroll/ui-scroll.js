'use strict';
/*
 * NOTE: There are a few improvements/bug fixes in this file which makes it deviates from the open source version.
				...
				compile: function(element, attr, linker) {
					return function($scope, $element, $attr, controllers) {
						...
						scrollHeight = function(elem) {
							// this if/else alters the open source version of this directive to allow for scrollHeights of 0
								...
								if (buffer.length && !shouldLoadBottom()) {
									...
									return datasource.get(next, bufferSize, function(result) {
										...
										if (result.length === 0) {
											eof = true;
											adapter.bottomPadding(0);
											// this event augments the open source version of this directive
											$scope.$emit('ui.scroll.itemsAdded', {
												type:'append',
												items:newItems
											});
											//
