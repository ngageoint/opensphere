 ...
 * @constructor
 */
os.im.action.cmd.FilterActionAdd = function(entry, opt_index, opt_parentId) {
  os.im.action.cmd.FilterActionAdd.base(this, 'constructor', entry, opt_index, opt_parentId);
