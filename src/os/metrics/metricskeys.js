...
os.metrics.Layer = {
  ...
  VECTOR_STROKE_COLOR: 'layers.features.changeVectorStrokeColor',
  ...
  FEATURE_STROKE_COLOR: 'layers.features.changeFeatureStrokeColor',
  ...
  FEATURE_STROKE_OPACITY: 'layers.features.changeFeatureStrokeOpacity',
