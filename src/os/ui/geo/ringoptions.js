 ...
 */
Module.directive('ringoptions', [directive]);
...
class Controller {
  ...
  constructor($scope, $element, $timeout) {
     ...
     * @type {string}
     */
    this['unitOptions'] = goog.object.getValues(Units);
  ...
  updateInterval(opt_update) {
    ...
    rings.forEach(function(ring, i) {
      ...
      ring['radius'] = math.roundWithPrecision(ring['radius'], math.precision(this['options'].interval));
    }, this);
  ...
  add(opt_update) {
    ...
    radius = math.roundWithPrecision(radius, math.precision(this['options'].interval));
