goog.module('os.ui.grid.DataGridUI');
...
/**
 * Register the datagrid directive.
 */
Module.directive('datagrid', [directive]);


/**
 * @deprecated Please use `os.ui.slick.SlickGridCtrl` instead.
 * @unrestricted
 */
class Controller {
  /**
  ...
  createGrid(el) {
    ...
    if (this.scope_['defaultSortColumn']) {
      var sortCol = olArray.find(this.scope_['columns'], function(ele) {
