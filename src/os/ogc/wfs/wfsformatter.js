...
os.ogc.wfs.WFSFormatter = function() {
   ...
   * @type {string}
   */
  this.contentType = os.ogc.wfs.WFSFormatter.DEFAULT_CONTENT_TYPE;
};
 ...
 * @const
 */
os.ogc.wfs.WFSFormatter.DEFAULT_CONTENT_TYPE = 'text/xml';
...
os.ogc.wfs.WFSFormatter.prototype.getContentType = function() {
  return this.contentType || os.ogc.wfs.WFSFormatter.DEFAULT_CONTENT_TYPE;
};
