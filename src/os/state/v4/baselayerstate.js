goog.module('os.state.v4.BaseLayerState');
...
const {isColorString, padHexColor, toRgbArray, toServerString} = goog.require('os.color');
const LayerAdd = goog.require('os.command.LayerAdd');
const DataManager = goog.require('os.data.DataManager');
const {isLocal, isFileSystem} = goog.require('os.file');
...
const LayerTag = goog.require('os.state.v4.LayerTag');
...
const {appendElement, appendElementNS, createElement, getElementValueOrDefault} = goog.require('os.xml');
...
/**
 */
class BaseLayerState extends XMLState {
  /**
   * Constructor.
   */
  constructor() {
