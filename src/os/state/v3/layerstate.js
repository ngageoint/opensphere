        ...
        switch (key) {
          ...
          case LayerTag.CSV_DATA_ROW:
            ...
            if (typeof value === 'number') {
              this.defaultConfigToXML(LayerTag.CSV_DATA_ROW, value - 1, layerEl);
            }
            break;
          case LayerTag.CSV_HEADER_ROW:
            // convert from 1 based indexing to 0 based. But needs to be set to -1 when useHeader is false.
            if (typeof value === 'number' && layerConfig[LayerTag.CSV_USE_HEADER]) {
              this.defaultConfigToXML(LayerTag.CSV_HEADER_ROW, value - 1, layerEl);
            } else {
