 ...
 */
const runFileStorageTests = function(idbEnabled) {
  ...
  describe(label, function() {
    ...
    it('should create a new file storage instance', function() {
      ...
      waitsFor(function() {
        if (idbEnabled) {
          ...
          return fs.storage instanceof AsyncStorageWrapper;
        }
    ...
    it('should load all files from the database', function() {
      ...
      runs(function() {
        ...
        var a = files[0];
        expect(a instanceof OSFile).toBeTruthy();
        ...
        var b = files[1];
        expect(b instanceof OSFile).toBeTruthy();
    ...
    it('should load single files from the database', function() {
      ...
      runs(function() {
        ...
        expect(file instanceof OSFile).toBeTruthy();
