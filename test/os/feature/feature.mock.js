...
const geoms = [{
  ...
  'coordinates': [
    [[10.0, 20.0], [15.0, 20.0], [15.0, 22.0], [10.0, 22.0], [10.0, 20.0]],
    [[11.0, 20.5], [14.0, 20.5], [14.0, 21.5], [11.0, 21.5], [11.0, 20.5]]
  ],
  'type': 'Polygon'
}, {
  'coordinates': [
    [[[0.0, 25.0], [5.0, 25.0], [5.0, 30.0], [0.0, 25.0]]],
    [[[10.0, 25.0], [15.0, 25.0], [15.0, 30.0], [10.0, 25.0]]]
  ],
  'type': 'MultiPolygon'
}, {
  'coordinates': [[
    [[20.0, 25.0], [25.0, 25.0], [25.0, 30.0], [20.0, 25.0]],
  ...
  'geometries': [{
    ...
    'coordinates': [
      [[60.0, 20.0], [65.0, 20.0], [65.0, 22.0], [60.0, 22.0], [60.0, 20.0]],
...
const cloneOrReturn = function(val) {
...
const antimeridian = function(obj, offset, lastOffset) {
 ...
 */
const getFeatures = function(opt_moveToAntimeridian) {
