...
describe('os.ui.geo.PositionUI', function() {
  const {Controller} = goog.module.get('os.ui.geo.PositionUI');

  it('should have sensible default precision', inject(function($rootScope) {
    var ctrl = new Controller($rootScope.$new());
