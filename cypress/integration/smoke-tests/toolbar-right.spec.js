...
describe('Toolbar right', function() {
  ...
  describe('Save menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(opensphere.Toolbar.Save.Menu.PANEL).should('not.be.visible');

      // Test
      cy.get(opensphere.Toolbar.Save.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Save.Menu.PANEL).should('be.visible');
      cy.get(opensphere.Toolbar.Save.Menu.STATE).should('be.visible');
      cy.get(opensphere.Toolbar.Save.Menu.SCREENSHOT).should('be.visible');
    ...
    it('Save state (from save menu)', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Save.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Save.Menu.STATE).click();
  ...
  describe('State menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(opensphere.Toolbar.States.Menu.PANEL).should('not.be.visible');

      // Test
      cy.get(opensphere.Toolbar.States.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.States.Menu.PANEL).should('be.visible');
      cy.get(opensphere.Toolbar.States.Menu.IMPORT_STATE).should('be.visible');
      cy.get(opensphere.Toolbar.States.Menu.SAVE_STATE).should('be.visible');
      cy.get(opensphere.Toolbar.States.Menu.DISABLE_STATES).should('be.visible');
    ...
    it('Import state', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.States.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.States.Menu.IMPORT_STATE).click();
      cy.get(imports.importDataDialog.DIALOG).should('be.visible');

      // Clean up
      cy.get(imports.importDataDialog.CANCEL_BUTTON).click();
      cy.get(imports.importDataDialog.DIALOG).should('not.exist');
      cy.get(opensphere.Toolbar.States.Menu.PANEL).should('not.exist');
    });
    ...
    it('Save state (from state menu)', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.States.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.States.Menu.SAVE_STATE).click();
      cy.get(dialogs.saveStateDialog.DIALOG).should('be.visible');
    ...
    it('Disable state', function() {
      ...
      cy.get(opensphere.statusBar.COORDINATES_TEXT).should('contain', '-33');
      cy.get(opensphere.Toolbar.Date.INPUT).should('have.value', '2019-01-06');

      // Test
      cy.get(opensphere.Toolbar.States.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.States.Menu.DISABLE_STATES).click();
  ...
  describe('Search tool', function() {
    it('Search provider', function() {
      // Setup
      cy.get(opensphere.Toolbar.Search.Menu.PANEL).should('not.be.visible');

      // Test
      cy.get(opensphere.Toolbar.Search.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Search.Menu.PANEL).should('be.visible');
      cy.get(opensphere.Toolbar.Search.Menu.searchTypes.COORDINATES_CHECKBOX).should('be.visible');
      cy.get(opensphere.Toolbar.Search.Menu.searchTypes.LAYERS_CHECKBOX).should('be.visible');
    ...
    it('Search', function() {
      // Setup
      cy.get(opensphere.Toolbar.Search.INPUT).should('be.empty');
      cy.get(opensphere.Toolbar.Search.Results.PANEL).should('not.be.visible');

      // Test
      cy.get(opensphere.Toolbar.Search.INPUT).type('street{enter}');
      cy.get(opensphere.Toolbar.Search.Results.PANEL).should('be.visible');
      cy.get(opensphere.Toolbar.Search.Results.PANEL).should('contain', 'Street Map');
      cy.get(opensphere.Toolbar.Search.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Search.Menu.PANEL).should('contain', 'street (All Search Types)');

      // Clean up
      cy.get(opensphere.Toolbar.Search.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Search.Menu.PANEL).should('not.be.visible');
      cy.get(opensphere.Toolbar.Search.CLEAR_BUTTON).click();
      cy.get(opensphere.Toolbar.Search.Results.PANEL).should('not.be.visible');
      cy.get(opensphere.Toolbar.Search.INPUT).should('be.empty');
    });
  });
  ...
  describe('Support menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(opensphere.Toolbar.Support.Menu.PANEL).should('not.be.visible');

      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.PANEL).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.ABOUT).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.CONTROLS).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.SHOW_TIPS).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.OPENSPHERE_CAPABILITIES).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.VIEW_ALERTS).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.VIEW_LOG).should('be.visible');
      cy.get(opensphere.Toolbar.Support.Menu.RESET_SETTINGS).should('be.visible');
    ...
    it('About', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.ABOUT).click();
    ...
    it('Controls', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.CONTROLS).click();
    ...
    it('Onboarding', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.SHOW_TIPS).click();
    ...
    it('OpenSphere capabilities', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.OPENSPHERE_CAPABILITIES).click();
    ...
    it('Alerts', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.VIEW_ALERTS).click();
    ...
    it('Reset settings', function() {
      ...
      // Test
      cy.get(opensphere.Toolbar.Support.Menu.BUTTON).click();
      cy.get(opensphere.Toolbar.Support.Menu.RESET_SETTINGS).click();
