...
describe('Toolbar right', function() {
  ...
  describe('Save menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(os.Toolbar.Save.MENU).should('not.be.visible');

      // Test
      cy.get(os.Toolbar.Save.BUTTON).click();
      cy.get(os.Toolbar.Save.MENU).should('be.visible');
      cy.get(os.Toolbar.Save.STATE).should('be.visible');
      cy.get(os.Toolbar.Save.SCREENSHOT).should('be.visible');
    ...
    it('Save state (from save menu)', function() {
      ...
      cy.get(os.Toolbar.Save.BUTTON).click();
      cy.get(os.Toolbar.Save.STATE).click();
  ...
  describe('State menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(os.Toolbar.States.MENU).should('not.be.visible');

      // Test
      cy.get(os.Toolbar.States.BUTTON).click();
      cy.get(os.Toolbar.States.MENU).should('be.visible');
      cy.get(os.Toolbar.States.IMPORT_STATE).should('be.visible');
      cy.get(os.Toolbar.States.SAVE_STATE).should('be.visible');
      cy.get(os.Toolbar.States.DISABLE_STATES).should('be.visible');
    ...
    it('Save state (from state menu)', function() {
      ...
      // Test
      cy.get(os.Toolbar.States.BUTTON).click();
      cy.get(os.Toolbar.States.SAVE_STATE).click();
      cy.get(os.saveStateDialog.DIALOG).should('be.visible');
  ...
  describe('Search tool', function() {
    it('Search provider', function() {
      // Setup
      cy.get(os.Toolbar.Search.Dropdown.MENU).should('not.be.visible');

      // Test
      cy.get(os.Toolbar.Search.Dropdown.BUTTON).click();
      cy.get(os.Toolbar.Search.Dropdown.MENU).should('be.visible');
      cy.get(os.Toolbar.Search.Dropdown.COORDINATES).should('be.visible');
      cy.get(os.Toolbar.Search.Dropdown.LAYERS).should('be.visible');
  ...
  describe('Support menu', function() {
    it('Menu options', function() {
      // Setup
      cy.get(os.Toolbar.Support.MENU).should('not.be.visible');

      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.MENU).should('be.visible');
      cy.get(os.Toolbar.Support.ABOUT).should('be.visible');
      cy.get(os.Toolbar.Support.CONTROLS).should('be.visible');
      cy.get(os.Toolbar.Support.SHOW_TIPS).should('be.visible');
      cy.get(os.Toolbar.Support.OPENSPHERE_CAPABILITIES).should('be.visible');
      cy.get(os.Toolbar.Support.VIEW_ALERTS).should('be.visible');
      cy.get(os.Toolbar.Support.VIEW_LOG).should('be.visible');
      cy.get(os.Toolbar.Support.RESET_SETTINGS).should('be.visible');
    ...
    it('About', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.ABOUT).click();
    ...
    it('Controls', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.CONTROLS).click();
    ...
    it('Onboarding', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.SHOW_TIPS).click();
      ...
      // Clean up
      cy.get(os.welcomeToOpenSphereDialog.STOP_SHOWING_TIPS).click();
      cy.get(os.welcomeToOpenSphereDialog.DIALOG).should('not.exist');
    });
    ...
    it('OpenSphere capabilities', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.OPENSPHERE_CAPABILITIES).click();
      ...
      cy.get(os.openSphereCapabilitiesDialog.SEARCH_FIELD).should('be.empty');
    ...
    it('Alerts', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.VIEW_ALERTS).click();
    ...
    it('Reset settings', function() {
      ...
      // Test
      cy.get(os.Toolbar.Support.BUTTON).click();
      cy.get(os.Toolbar.Support.RESET_SETTINGS).click();
