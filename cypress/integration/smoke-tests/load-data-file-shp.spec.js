...
describe('SHP import', function() {
  ...
  it('Load data from SHP', function() {
    ...
    cy.get(imports.SHPImportDialog.DIALOG).should('be.visible');
    cy.get(imports.SHPImportDialog.NEXT_BUTTON).click();
    cy.get(imports.SHPImportDialog.DONE_BUTTON).click();
