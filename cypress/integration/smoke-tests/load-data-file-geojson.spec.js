...
describe('Geojson import', function() {
  ...
  it('Load data from geojson', function() {
    ...
    cy.get(imports.importGeoJSONDialog.DIALOG).should('be.visible');
    cy.get(imports.importGeoJSONDialog.NEXT_BUTTON).click();
    cy.get(imports.importGeoJSONDialog.DONE_BUTTON).click();
