...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'vendor/jquery/jquery.event.drag-2.3.0.js', watched: false, included: true, served: true},
      {pattern: 'vendor/jquery-ui/jquery-ui-1.12.1.min.js', watched: false, included: true, served: true},
      ...
      {pattern: resolver.resolveModulePath('select2/select2.js', __dirname), watched: false, included: true, served: true},
      {pattern: 'vendor/angular-ui/angular-ui.js', watched: false, included: true, served: true},
      {pattern: 'vendor/slick/slick.core.js', watched: false, included: true, served: true},
      {pattern: 'vendor/slick/slick.dataview.js', watched: false, included: true, served: true},
      {pattern: 'vendor/slick/slick.grid.js', watched: false, included: true, served: true},
