 ...
 *
 *  - `angular.JQLite` is redefined using a `@typedef` to resolve compiler
 *    confusion between jQuery and Angular's JQLite.
 *  - `currentTarget`, `originalEvent`, and `target` added to angular.Scope.Event
 *
 ...
 * @return {!angular.JQLite}
 */
angular.JQLite.detach = function() {};

/**
 * @return {!angular.JQLite}
 */
angular.JQLite.empty = function() {};
 ...
 */
angular.JQLite.one = function(events, dataOrHandler, opt_handler) {};
 ...
 * @return {!angular.JQLite}
 */
angular.JQLite.triggerHandler = function(typeOrEvent, opt_value) {};
...
/** @type {TARGET} */
angular.Scope.Event.prototype.currentTarget;
...
/** @type {EVENT} */
angular.Scope.Event.prototype.originalEvent;
...
/** @type {TARGET} */
angular.Scope.Event.prototype.target;
